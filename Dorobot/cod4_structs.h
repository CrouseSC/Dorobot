...
struct playerState_s // adress is 0x00794474
{
...
struct usercmd_s
{
    ...
    unsigned char offHandIndex;
    unsigned char forward;
    char side;
    float meleeChargeYaw;
    unsigned char meleeChargeDist;
    unsigned char selectedLocation[2];
};
...
#define USERCMD_SIDE_RIGHT 127
#define USERCMD_SIDE_LEFT -127
#define USERCMD_FORWARD_FORWARD 127
#define USERCMD_FORWARD_BACK -127
#define USERCMD_BUTTONS_SPRINT 8194
#define USERCMD_BUTTONS_JUMP 1024
...
struct cg_t // adress 0x0074E338
{
	...
	playerState_s PredictedPlayerState; //0x4613C
	char _0x490A0[0x228];
